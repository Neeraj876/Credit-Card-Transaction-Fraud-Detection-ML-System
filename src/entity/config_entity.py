...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.feature_store_file_path: str = os.path.join(ARTIFACT_DIR_NAME, DATA_INGESTION_FEATURE_STORE_DIR, FILE_NAME)

        self.training_file_path: str = os.path.join(ARTIFACT_DIR_NAME, DATA_INGESTION_INGESTED_DATA_DIR, TRAIN_FILE_NAME)

        self.testing_file_path: str = os.path.join(ARTIFACT_DIR, DATA_INGESTION_INGESTED_DATA_DIR, TEST_FILE_NAME)
